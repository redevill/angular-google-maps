...
@agm/snazzy-info-window is an extension for the @agm/core-sysjs package that provides solutions for styleable/customizable info windows with the help of ['Snazzy Info Window'](https://github.com/atmist/snazzy-info-window).
